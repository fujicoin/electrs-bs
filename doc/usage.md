...
Allow Fujicoin daemon to sync before starting Electrum server:
```bash
...
Otherwise, [`~/.fujicoin/.cookie`](https://github.com/fujicoin/fujicoin/blob/0212187fc624ea4a02fc99bc57ebd413499a9ee1/contrib/debian/examples/fujicoin.conf#L70-L72) will be read, allowing this server to use fujicoind JSONRPC interface.
...
$ docker run --network host \
             --volume /home/roman/.fujicoin:/home/user/.fujicoin:ro \
